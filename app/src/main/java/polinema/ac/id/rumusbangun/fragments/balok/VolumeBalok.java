 ...
 * {@link VolumeBalok.OnFragmentInteractionListener} interface
 * to handle interaction events.
 */
public class VolumeBalok extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final EditText vPanjangBalok = view.findViewById(R.id.txt_vPanBalok);
        final EditText vLebarBalok = view.findViewById(R.id.txt_vleBalok);
        final EditText vTinggiBalok = view.findViewById(R.id.txt_vtiBalok);
        Button calculation = view.findViewById(R.id.calculate_vBalok);
        calculation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(mListener != null){
                    String strvPanjang = vPanjangBalok.getText().toString();
    ...
    public interface OnFragmentInteractionListener {
        ...
        void hitungVolumeBalok(float hasil);
    }
}
