 ...
 * {@link LuasPersegi.OnFragmentInteractionListener} interface
...
public class LuasPersegi extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final EditText Sisi = view.findViewById(R.id.txt_LuasSisiPersegi);
        Button calculation = view.findViewById(R.id.calculate_LuasPersegi);
            ...
            public void onClick(View view) {
                if(mListener != null){
                    ...
                    if(!TextUtils.isEmpty(strlpSisi)){
                        ...
                        rumus r = new rumus();
                        r.luasPersegi(intlpSisi);
                        mListener.hitungLuasPersegi(r.getHasil());
                    }else{
    ...
    public interface OnFragmentInteractionListener {
        ...
        void hitungLuasPersegi(float hasil);
    }
}
