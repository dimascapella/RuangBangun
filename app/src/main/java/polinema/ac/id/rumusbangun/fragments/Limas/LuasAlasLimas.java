 ...
 * {@link LuasAlasLimas.OnFragmentInteractionListener} interface
 * to handle interaction events.
 */
public class LuasAlasLimas extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_luas_alas_limas, container, false);
        final EditText Alas = view.findViewById(R.id.txt_aLimas);
        final EditText tinggi = view.findViewById(R.id.txt_tLimas);
        Button calculation = view.findViewById(R.id.calculate_laLimas);
    ...
    public interface OnFragmentInteractionListener {
        ...
        void hitungLuasAlasLimas(float hasil);
    }
}
