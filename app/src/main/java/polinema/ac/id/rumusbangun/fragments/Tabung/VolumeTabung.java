 ...
 * {@link VolumeTabung.OnFragmentInteractionListener} interface
...
public class VolumeTabung extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final EditText jari = view.findViewById(R.id.txt_vJariTabung);
        final EditText tinggi = view.findViewById(R.id.txt_vtTabung);
        Button calculation = view.findViewById(R.id.calculate_vTabung);
            ...
            public void onClick(View view) {
                if(mListener != null){
                    ...
                    if(!TextUtils.isEmpty(strjari) && !TextUtils.isEmpty(strtinggi)){
                        ...
                        rumus r = new rumus();
                        r.vTabung(intJari, intTinggi);
                        mListener.hitungVolumeTabung(r.getHasil());
                    }else{
    ...
    public interface OnFragmentInteractionListener {
        ...
        void hitungVolumeTabung(float hasil);
    }
}
