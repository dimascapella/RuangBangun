 ...
 * {@link LuasPermukaanTabung.OnFragmentInteractionListener} interface
 * to handle interaction events.
 */
public class LuasPermukaanTabung extends Fragment {

    private OnFragmentInteractionListener mListener;

    public LuasPermukaanTabung() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_luas_permukaan_tabung, container, false);
        final EditText luasAlas = view.findViewById(R.id.txt_lplaTabung);
        final EditText luasSelimut = view.findViewById(R.id.txt_lplsTabung);
        Button calculation = view.findViewById(R.id.calculate_lpTabung);
    ...
    public interface OnFragmentInteractionListener {
        ...
        void hitungLuasPermukaanTabung(float hasil);
    }
}
